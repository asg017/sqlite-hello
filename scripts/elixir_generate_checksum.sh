...
envsubst < bindings/elixir/sqlite-hello-checksum.exs.tmpl > bindings/elixir/sqlite-hello-checksum.exs
echo "✅ generated bindings/elixir/sqlite-hello-checksum.exs"
